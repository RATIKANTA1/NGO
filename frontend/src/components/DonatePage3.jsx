...
import image from "/src/assets/donationc.jpg"
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-r bg-gray-100 flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-5xl">
          <h2 className="md:text-5xl text-3xl font-semibold text-center text-gray-800 mb-8">
            Provide Shelter and Care: Donate to Support Stray Animals
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 shadow-lg shadow-black">
            ...
            <div className="hidden lg:flex flex-col  p-3">
              ...
              />
              <p className='text-justify mt-6'>"Ensuring the safety of animals is not just about protection; it's about preserving the bond we share with all living beings. Every act of kindness towards them reflects the depth of our humanity. In safeguarding animals, we safeguard our own soul."</p>
