                ...
                <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl " >
                    ...
                    <div className="px-4 py-3 w-72">
                        ...
                        <div className="flex items-center justify-center">
                            <Link to={"/Donate2"} target='_blank'><button className='btn-primary'>Donate</button></Link>
                        </div>
                    </div>
                </div>
                <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                    ...
                    <div className="px-4 py-3 w-72">
                        ...
                        <div className="flex items-center justify-center">
                            <Link to={"/Donate3"} target='_blank'><button className='btn-primary'>Donate</button></Link>
                        </div>
                    </div>
                </div>
                <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl" >
                    ...
                    <div className="px-4 py-3 w-72">
                        ...
                        <div className="flex items-center justify-center">
                            <Link to={"/Donate"} target='_blank'><button className='btn-primary'>Donate</button></Link>
                        </div>
                    </div>
                </div>
            </section>
