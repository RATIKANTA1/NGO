        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 shadow-lg shadow-black">
            ...
            <div className="hidden lg:flex flex-col  p-3">
              <img
                src="https://i0.wp.com/world-education-blog.org/wp-content/uploads/2014/03/1-india.jpg?fit=1024%2C683&ssl=1"
                alt="Girls' Education"
                className="rounded-xl shadow-lg w-full h-fit"
              />
              <p className='text-justify mt-6'>Support a girl's education and unlock her limitless potential. Your donation provides the tools she needs to succeed. Together, we can create lasting change for her and her community.</p>
