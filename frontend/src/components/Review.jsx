...
import defaultPic from "../assets/defualt pic.png"
        ...
        <div >
            <div className='px-4 md:px-14  py-6 max-w-screen-2xl mx-auto bg-custom-color bg-custom-gradient' id="testimonial">
                <div className='md:w-1/2 mx-auto text-center' data-aos="zoom-out-up" data-aos-duration="1000" data-aos-offset="170" data-aos-easing="ease-in-out">
                    <h2 className='text-4xl text-gray-500 font-semibold mb-2'>Review</h2>
                </div>
                        ...
                        {review.map((review) => (
                            ...
                            <div class="max-w-xl mt-16  mx-auto">
                                <div class="flex flex-col items-center text-center">
                                    <img src={review.img} class="w-28 h-28 rounded-full shadow-[0_2px_22px_-4px_rgba(93,96,127,0.6)] border-2 border-white" alt={defaultPic} />
                                    <div class="mt-4">
                                ...
                                <div class="mt-4 text-center px-2 lg:px-12">
                                    <p class="text-sm leading-2">{review.review}</p>
                                </div>
