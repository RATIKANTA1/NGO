...
const RegisterVolunteer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    axios.post('https://sheet.best/api/sheets/c4e67d86-d931-4aab-8160-cf6d0ccdb60a', allData)
      .then((response) => {
        Swal.fire({
          title: 'Success',
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-orange-50 p-4">
        <div className="w-full md:w-1/2 bg-white p-16 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-center mb-8">Volunteer Registration</h2>
...
//        axios.post('https://sheet.best/api/sheets/fffdffcc-20ed-4fd4-a8ba-07ce360f948b',allData).then((response)=>{
...
//             <div>
//               <label htmlFor="availability" className="block text-sm font-medium text-gray-700">Availability</label>
//               <input type="text" id="availability" name="availability" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"  value={availability}
//               onChange={(e)=>setAvailability(e.target.value)} required />
//             </div>
//             <div>
//               <label htmlFor="skills" className="block text-sm font-medium text-gray-700">Skills</label>
//               <textarea id="skills" name="skills" rows="3" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value={skills}
//               onChange={(e)=>setSkills(e.target.value)} required></textarea>
//             </div>
//             {/* <div>
